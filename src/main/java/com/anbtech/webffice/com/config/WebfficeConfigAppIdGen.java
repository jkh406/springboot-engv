...
import com.anbtech.webffice.com.cmm.util.WebfficeIdGnrBuilder;
import org.egovframe.rte.fdl.idgnr.impl.EgovTableIdGnrServiceImpl;
import org.egovframe.rte.fdl.idgnr.impl.strategy.EgovIdGnrStrategyImpl;

/**
 * @ClassName : WebfficeConfigAppIdGen.java
 ...
 */
@Configuration
public class WebfficeConfigAppIdGen {
	@Autowired
	...
	public EgovTableIdGnrServiceImpl egovBBSMstrIdGnrService() {
		return new WebfficeIdGnrBuilder().setDataSource(dataSource).setEgovIdGnrStrategyImpl(new EgovIdGnrStrategyImpl())
			.setBlockSize(10)
			.setTable("IDS")
			.setTableName("BBS_ID")
			.setPreFix("BBSMSTR_")
	...
	public EgovTableIdGnrServiceImpl egovWikiBookmarkIdGnrService() {
		return new WebfficeIdGnrBuilder().setDataSource(egovDataSource)
