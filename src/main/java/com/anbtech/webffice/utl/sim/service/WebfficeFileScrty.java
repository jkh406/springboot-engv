package com.anbtech.webffice.utl.sim.service;
 ...
 * </pre>
 */
public class WebfficeFileScrty {
	// 파일구분자
	static final String FILE_SEPARATOR = System.getProperty("file.separator");
	// 버퍼사이즈
	static final int BUFFER_SIZE = 1024;

	private static final Logger LOGGER = LoggerFactory.getLogger(WebfficeFileScrty.class);
	...
	public static boolean encryptFile(String source, String target) throws Exception {
		...
		String sourceFile = WebfficeWebUtil.filePathBlackList(source.replace("\\", FILE_SEPARATOR).replace("/", FILE_SEPARATOR));
		String targetFile = WebfficeWebUtil.filePathBlackList(target.replace("\\", FILE_SEPARATOR).replace("/", FILE_SEPARATOR));
