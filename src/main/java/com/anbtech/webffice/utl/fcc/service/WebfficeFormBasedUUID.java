...
public class WebfficeFormBasedUUID implements Serializable {
    /*
     ...
     */
    private WebfficeFormBasedUUID(byte[] data) {
        long msb = 0;
        long lsb = 0;
        for (int i = 0; i < 8; i++)
     ...
     * @param leastSigBits
     */
    public WebfficeFormBasedUUID(long mostSigBits, long leastSigBits) {
     ...
     */
    public static WebfficeFormBasedUUID randomUUID() {
        ...
        return new WebfficeFormBasedUUID(randomBytes);
    }
     ...
     */
    public static WebfficeFormBasedUUID nameUUIDFromBytes(byte[] name) {
        MessageDigest md;
        try {
        ...
        return new WebfficeFormBasedUUID(md5Bytes);
    }
     ...
     */
    public static WebfficeFormBasedUUID fromString(String name) {
        ...
        return new WebfficeFormBasedUUID(mostSigBits, leastSigBits);
    }
	...
	public boolean equals(Object obj) {
    	if (obj == null)
        	return false;
    	if (!(obj instanceof WebfficeFormBasedUUID))
            return false;
        if (((WebfficeFormBasedUUID) obj).variant() != this.variant())
            return false;
        WebfficeFormBasedUUID id = (WebfficeFormBasedUUID) obj;
     ...
     */
    public int compareTo(WebfficeFormBasedUUID val) {
